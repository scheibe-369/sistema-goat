...
export function AppSidebar() {
  ...
  return (
    ...
    >
      ...
      <SidebarContent className="px-0 py-0 border-none bg-transparent backdrop-blur-none">
      ...
      <SidebarFooter className="p-0 border-none bg-transparent">
        <SidebarMenu className="space-y-4 flex flex-col items-center">
          <SidebarMenuItem className="w-fit">
            <SidebarTrigger className="flex items-center justify-center w-12 h-12 rounded-full bg-black/80 text-white hover:bg-purple-600/20 hover:text-white shadow-lg hover:shadow-xl transition-all duration-300 border-none" />
          </SidebarMenuItem>
          <SidebarMenuItem className="w-fit">
            <SidebarMenuButton 
              tooltip="Sair"
